...
function ENT:Draw()
	...
	cam.Start3D2D(Pos + Ang:Up() * 8.5, Ang, 0.11)
	    draw.WordBox(2, -TextWidth3*0.5, -78, owner, "HUDNumber5", Color(0, 0, 0, 100), Color(255,0,0,255))
		draw.WordBox(2, -TextWidth*0.5, -30, txt1, "HUDNumber5", Color(0, 0, 0, 100), Color(math.random(1,255),math.random(1,255),math.random(1,255),255))
